...
void notaR(int nota, int duracion, int t_rele){
  tone(pinBuzzer,nota, duracion);

    suenaRele();
    delay(t_rele);
    suenaRele();
    delay(duracion - t_rele);
    noTone(pinBuzzer);
    delay(duracion);
}
void notaRR(int nota, int duracion, int t_rele1, int t_rele2){
  tone(pinBuzzer,nota, duracion);
    ...
    delay(t_rele2);
    suenaRele();
    delay(duracion - t_rele1 - t_rele2);
    noTone(pinBuzzer);
    delay(duracion);
}
...
void setup() {
 ...
 lcd.setCursor(0,0);
 lcd.print("La Bachata      ");
 lcd.setCursor(0,1);
 lcd.print("Manuel Turizo   ");
...
textopan("Ando manejando  ","                ");
	...
	nota(C2,c);
	nota(As,c);
textopan("por las calles  ","que me besaste  ");
	nota_sf(C2,c);
	nota(D2,c);
	nota(D2,c);
	nota(D2,c);
...
textopan("que un dia me   ","dedicaste       ");
	nota_sf(C2,c);
	nota(D2,c);
	nota(D2,c);
	nota(D2,c);
...
textopan("Te diria que    ","volvieras       ");
	nota(F2,c);
	nota(F2,c);
